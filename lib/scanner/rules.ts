...
const GENERIC_SECRET_NAMES =
  /\b(SECRET_KEY|API_SECRET|PRIVATE_KEY|DATABASE_URL|SUPABASE_SERVICE_ROLE_KEY|STRIPE_SECRET_KEY|OPENAI_API_KEY|ANTHROPIC_API_KEY|VERCEL_TOKEN|GITHUB_TOKEN)\b/i
