...
const SUPPORTED_EXTENSIONLESS_FILES = new Set(["README", "LICENSE", "NOTICE", "DOCKERFILE", ".BADGERIGNORE", ".BADGERIGNORE"])
...
export function projectPathPriorityScore(filePath: string) {
  ...
  if (lowerName === ".badgerignore" || lowerName === ".badgerignore") score += 9_500
